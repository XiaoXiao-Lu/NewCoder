...
/**
 * @author Kinnon
 * @create 2022-09-12 16:57
 */
@Slf4j
public class PostScoreRefreshJob implements Job , NewCoderConstant {
    ...
    private void refresh(int postId) {
        ...
        // 点赞数量
        long likeCount = likeService.getLikeCount(ENTITY_TYPE_POST, postId);
