...
public class ElasticsearchService {
    ...
    public  List<Map<String, Object>> searchDiscussPost(String keyword,int current,int limit){
        ...
        // 遍历返回的内容进行处理
        if (searchHits.size() != 0 && searchHits != null) {
        ...
        List<Map<String, Object>> discussMap = new ArrayList<>();
        if (discussPosts.size() != 0 && discussPosts != null) {
